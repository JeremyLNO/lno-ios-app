...
privacy = "PrivacyInfo.xcprivacy"  # un par cible : Apple exige un manifeste propre à chaque extension
...
privacy_app_ref = u("fileref.app.privacy")
privacy_widget_ref = u("fileref.widget.privacy")
privacy_app_build_file = u("buildfile.app.privacy")
privacy_widget_build_file = u("buildfile.widget.privacy")
...
L('\t\t%s /* %s in Resources */ = {isa = PBXBuildFile; fileRef = %s /* %s */; };' % (privacy_app_build_file, privacy, privacy_app_ref, privacy))
L('\t\t%s /* %s in Resources */ = {isa = PBXBuildFile; fileRef = %s /* %s */; };' % (privacy_widget_build_file, privacy, privacy_widget_ref, privacy))
...
L('\t\t%s /* %s */ = {isa = PBXFileReference; lastKnownFileType = text.xml; path = %s; sourceTree = "<group>"; };' % (privacy_app_ref, privacy, privacy))
L('\t\t%s /* %s */ = {isa = PBXFileReference; lastKnownFileType = text.xml; path = %s; sourceTree = "<group>"; };' % (privacy_widget_ref, privacy, privacy))
...
L('\t\t\t\t%s /* %s */,' % (privacy_widget_ref, privacy))
...
L('\t\t\t\t%s /* %s in Resources */,' % (privacy_app_build_file, privacy))
L('\t\t\t);')
L('\t\t\trunOnlyForDeploymentPostprocessing = 0;')
L('\t\t};')
L('\t\t%s /* Resources */ = {' % widget_resources_phase)
...
L('\t\t\t\t%s /* %s in Resources */,' % (privacy_widget_build_file, privacy))
L('\t\t\t);')
L('\t\t\trunOnlyForDeploymentPostprocessing = 0;')
L('\t\t};')
